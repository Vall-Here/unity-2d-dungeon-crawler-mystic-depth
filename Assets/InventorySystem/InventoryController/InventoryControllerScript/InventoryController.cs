...
namespace InventorySystem
{
    ...
    {
        // [SerializeField]
        private bool iUnderstandTheSetup = true; // Ensure this is the sole instance of InventoryController.
        ...
        public bool RemoveItem(string inventoryName,string itemType, int amount)
        {
            if (!(TestInventoryDict(inventoryName) && TestItemDict(itemType)))
            {
                return false;
